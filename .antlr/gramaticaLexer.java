...
public class gramaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "T__26", "T__27", "OpComp", "OR", "AND", "NOT", "OpIgual", "OpAsign", 
			"LQUOTE", "RQUOTE", "COMMENT_SIMPLE", "COMMENT_MULTI", "BOOLEAN", "STRING", 
			"NUMBER", "LETTER", "LETTER_L", "LETTER_U", "DIGIT", "INDIVIDUO", "VARIABLE", 
			"WS"
		};
	}
